...
/**
 * The networks this application may be configured for. Preview, preprod and mainnet are refused
 * until the signet singleton and the vault are deployed there.
 */
...
export const MIDNIGHT_NETWORK_DEFAULTS: Readonly<Record<MidnightNetworkId, MidnightNetworkConfig>> =
  {
    [MidnightNetwork.Undeployed]: {
...
export type MidnightNetworkEnv = z.infer<typeof midnightNetworkEnvSchema>

export function midnightNetworkConfigFromEnv(env: MidnightNetworkEnv): MidnightNetworkConfig {
