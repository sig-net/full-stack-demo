...
/**
 * Forwards controlled and uncontrolled native input values unchanged.
 *
 * @param properties - Native input properties and optional class names.
 * @returns The input element with shared interaction styles.
 */
function Input(properties: React.ComponentProps<"input">): React.JSX.Element {
  const { className, type, ...props } = properties;
  return (
    <input
      type={type}
      data-slot="input"
