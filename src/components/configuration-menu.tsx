    ...
    <Popover modal open={open} onOpenChange={setOpen}>
      <Tooltip title="Configuration">
        <PopoverTrigger asChild>
          <Button variant="ghost" size="icon-xs" aria-label="Configuration">
      ...
      <PopoverContent align="end" aria-label="Configuration" size="wide">
        ...
        <form
          ...
          onSubmit={(event) => {
            ...
            setResult(model.apply() ? "Configuration applied." : "Correct the highlighted fields.");
          }}
        >
                  ...
                  return (
                    <div key={field.key}>
                      ...
                      <div className="ds-row ds-tight">
                        ...
                        <Tooltip title={field.help} side="left">
                          <Button
                            type="button"
                            variant="ghost"
                            size="icon-sm"
                      ...
                      <div id={`${fieldId}-feedback`} className="ds-caption break-words">
                        {field.difference && (
                          <p className="ds-warning">
                            {field.difference.message} Wallet value: {field.difference.walletValue}
                          </p>
                        )}
                        {field.error && (
